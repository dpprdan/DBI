...
- Break lines at meaning boundaries
  ([\#751](https://github.com/r-dbi/DBI/issues/751)).

- Drop the branch from the coverage badge
  ([\#750](https://github.com/r-dbi/DBI/issues/750)).

- Harmonize README and pkgdown front page rendering
  ([\#749](https://github.com/r-dbi/DBI/issues/749)).

- Use [`pak::pak()`](https://pak.r-lib.org/reference/pak.html) for the
  development install
  ([\#747](https://github.com/r-dbi/DBI/issues/747)).
...
- Skip the MariaDB server where MariaDB ships none
  ([\#746](https://github.com/r-dbi/DBI/issues/746)).

#### ci

- Demote arrow’s build failure on aarch64 Windows
  ([\#745](https://github.com/r-dbi/DBI/issues/745)).

#### ci

- Survive an archived website package, and run MariaDB 12.3 on Resolute
  ([\#744](https://github.com/r-dbi/DBI/issues/744)).
...
- Ci: Unify fledge.yaml across cynkratemplate and fledge
  ([\#86](https://github.com/r-dbi/DBI/issues/86)).

## DBI 1.3.0.9008 (2026-05-13)
